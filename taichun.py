...
def printText(img, num1_1, num1_2, num2_1, num2_2, num3_1, num3_2, num4_1, num4_2):
    ...
    cv2.putText(img, str(num2_1[0])+"/"+str(num2_2[0]), (1710, y1), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    cv2.putText(img, str(num2_1[1])+"/"+str(num2_2[1]), (1710, y2), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    cv2.putText(img, str(num2_1[2])+"/"+str(num2_2[2]), (1710, y3), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    cv2.putText(img, str(num2_1[3])+"/"+str(num2_2[3]), (1710, y4), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    ...
    cv2.putText(img, str(num1_1[0])+"/"+str(num1_2[0]), (210, y1+830), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    cv2.putText(img, str(num1_1[1])+"/"+str(num1_2[1]), (210, y2+830), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    cv2.putText(img, str(num1_1[2])+"/"+str(num1_2[2]), (210, y3+830), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    cv2.putText(img, str(num1_1[3])+"/"+str(num1_2[3]), (210, y4+830), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    ...
    cv2.putText(img, str(num3_1[0])+"/"+str(num3_2[0]), (240, y1), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    cv2.putText(img, str(num3_1[1])+"/"+str(num3_2[1]), (240, y2), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    cv2.putText(img, str(num3_1[2])+"/"+str(num3_2[2]), (240, y3), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    cv2.putText(img, str(num3_1[3])+"/"+str(num3_2[3]), (240, y4), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    ...
    cv2.putText(img, str(num4_1[0])+"/"+str(num4_2[0]), (1710, y1+830), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    cv2.putText(img, str(num4_1[1])+"/"+str(num4_2[1]), (1710, y2+830), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    cv2.putText(img, str(num4_1[2])+"/"+str(num4_2[2]), (1710, y3+830), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    cv2.putText(img, str(num4_1[3])+"/"+str(num4_2[3]), (1710, y4+830), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    ...
    while True:
        ...
        for id, labelName in enumerate(yolo.nms_labelNames):
            ...
            if(in_range(frameLayout, box, 1)==True or in_range(frameLayout, box, 2)==True or in_range(frameLayout, box, 3)==True or in_range(frameLayout, box, 4)==True):
                ...
                cv2.putText(frame, labelName, (box[0]+30, box[1]-10), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 0, 255), 2)
