...
calculateLine2 = [(1038, 330), (1740, 480)]  #[(from(x,y), to(x,y)]
...
def draw_CalculateLine(frame):
    ...
    cv2.line(frame, (calculateLine1[0][0],calculateLine1[0][1]), (calculateLine1[1][0],calculateLine1[1][1]), (0, 255, 0), 10)
    cv2.line(frame, (calculateLine2[0][0],calculateLine2[0][1]), (calculateLine2[1][0],calculateLine2[1][1]), (0, 254, 0), 10)
    cv2.line(frame, (calculateLine3[0][0],calculateLine3[0][1]), (calculateLine3[1][0],calculateLine3[1][1]), (0, 253, 0), 10)
    cv2.line(frame, (calculateLine4[0][0],calculateLine4[0][1]), (calculateLine4[1][0],calculateLine4[1][1]), (0, 252, 0), 10)
...
def in_range(img, bbox):
    ...
    if(img[cy,cx][0]==0 and img[cy,cx][1]==0 and img[cy,cx][2]==255) or (img[cy,cx][0]==0 and img[cy,cx][1]==255 and img[cy,cx][2]==0):
        #print("({},{}) --> True:{},{},{},{}".format(cx,cy,calculateLine1[0][0],calculateLine1[1][0], calculateLine1[0][1], calculateLine1[1][1]) )
        return True

    else:
        #print("({},{}) --> False:{},{},{},{}".format(cx,cy,calculateLine1[0][0],calculateLine1[1][0], calculateLine1[0][1], calculateLine1[1][1]) )
        return False
...
def printText(img, num1_1, num1_2):
    ...
    cv2.putText(img, "Car:", (1530, y1), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (255, 0, 0), 2)
    cv2.putText(img, "Truck:", (1530, y2), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (255, 0, 0), 2)
    cv2.putText(img, "Bus:", (1530, y3), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (255, 0, 0), 2)
    cv2.putText(img, "Motorbike:", (1530, y4), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (255, 0, 0), 2)
    cv2.putText(img, "-", (1790, y1), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    cv2.putText(img, "-", (1790, y2), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    cv2.putText(img, "-", (1790, y3), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    cv2.putText(img, "-", (1790, y4), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)

    cv2.putText(img, "Car:", (30, y1+730), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (255, 0, 0), 2)
    cv2.putText(img, "Truck:", (30, y2+730), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (255, 0, 0), 2)
    cv2.putText(img, "Bus:", (30, y3+730), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (255, 0, 0), 2)
    cv2.putText(img, "Motorbike:", (30, y4+730), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (255, 0, 0), 2)
    cv2.putText(img, str(num1_1[0])+"/"+str(num1_2[0]), (260, y1+730), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    cv2.putText(img, str(num1_1[1])+"/"+str(num1_2[1]), (260, y2+730), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    cv2.putText(img, str(num1_1[2])+"/"+str(num1_2[2]), (260, y3+730), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    cv2.putText(img, str(num1_1[3])+"/"+str(num1_2[3]), (260, y4+730), cv2.FONT_HERSHEY_SIMPLEX, fontSize, (0, 255, 0), 3)
    ...
    while True:
        ...
        if(frameID>0 and len(now_CENTROIDS)>0):
            ...
            for id, now_id in enumerate(obj_target):
                ...
                color_now_1 = frameLayout[now_CENTROIDS[now_id][1],now_CENTROIDS[now_id][0]]
                color_last_1 = frameLayout[last_CENTROIDS[id][1],last_CENTROIDS[id][0]]
                print(color_now_1)
                print(color_last_1)

                UP_1 = (color_now_1 == [0,255,0]).all() and (color_last_1 == [0,0,255]).all() 
                DOWN_1 = (color_last_1 == [0,255,0]).all() and (color_now_1==[0,0,255]).all()
                print(UP_1, DOWN_1)
        ...
        num1 = (count_Car1, count_Truck1, count_Bus1, count_Motorbike1)
        num2 = (count_Car2, count_Truck2, count_Bus2, count_Motorbike2)
        frame = printText(frame, num1, num2)
